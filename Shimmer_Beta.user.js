...
(function() {var css = [
	...
	"    color: #715099",
	"}",
	"a.link:visited:hover, a.link:visited:active, a.link:visited:focus {",
	"    color: #44305B",
	"}",
	".row,",
	".subbans-bans {",
	...
	"    border-color: #000 !important",
	"}",
	".reports-unignored, .disc.comment {",
	"    border-color: #191919 !important;",
	"}",
	".account-nav a:hover,",
	...
	"    border-color: #171717 !important;",
	"}",
	".btn-default.btn-sm.btn:hover, .btn-sm:hover {",
	"    background: #202020 !important;",
	"    border-color: #171717 !important;",
	"}",
	".btn-default.btn-sm.btn:active, .btn-sm:active {",
	...
	"}",
	".types > .btn-group-vertical label:hover,.types > .btn-group-vertical label:active, .types > .btn-group-vertical label:focus {",
	"    background: #252525 !important;",
	"    border-color: transparent !important;",
	"    color:  #999 !important;",
	"}",
